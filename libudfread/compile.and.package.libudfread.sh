...
PROG_NAME="libudfread"
PROG_VERSION="1.1.1"
ARCHITECTURE="arm64"
PKG_DESTINATION_PATH="$HOME/debpkgs/${PROG_NAME}_${PROG_VERSION}_${ARCHITECTURE}"
PROG_EXTERNAL_LOCATION="https://code.videolan.org/videolan/$PROG_NAME/-/archive/$PROG_VERSION/$PROG_NAME-$PROG_VERSION.tar.gz"
PROG_DEPENDS="libc6"
PROG_DESCRIPTION="UDF reader"
PRE_INSTALL="no"
